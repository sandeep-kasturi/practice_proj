...
public interface StudentRepository extends JpaRepository<Student, Long>{
    ...
    List<Student> getStudentFirstNameOrLastName(String firstName, String LastName);
    ...
    List<Student> getStudentByEmailAddressNative(String email);

    //Native Names Param Query
    @Query(
        value = "select * from tbl_student  where email_address = :emailId",
        nativeQuery = true
    )
    List<Student> getStudentByEmailAddressNativeNamedParam(@Param("emailId") String email);
